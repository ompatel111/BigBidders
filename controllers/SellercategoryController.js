...
exports.getCreateCategory = (req, res) => {
    try {
        ...
        const errors = {};
        res.render('seller_create_categories', { editMode, errors });
    } catch (error) {
        console.error('Error rendering seller_create_categories form:', error);
...
exports.getAllCategories = async (req, res) => {
    try {
        ...
        res.render('seller_categories', { categories });
    } catch (error) {
...
exports.createCategory = async (req, res) => {
    try {
        ...
        upload(req, res, async function (err) {
            if (err) {
                ...
                if (err instanceof multer.MulterError) {
                    ...
                    return res.redirect('/seller_create_categories?error=true');
                } else {
            ...
            if (Object.keys(errors).length > 0) {
                const categories = await Category.find();
                return res.render('seller_create_categories', { editMode: false, category: {}, errors });
            }
        ...
        res.redirect('/seller_create_categories?error=true');
    }
};
...
exports.getCategoryForm = async (req, res) => {
    try {
        ...
        res.render('seller_create_categories', { editMode, category, errors });
    } catch (error) {
